...
Beef – organic beef mince, burgers, meatballs
turkey
...
FIELDS EXPLAINED
================
department        The department values is fixed and is set as meat
...
VALUES 
('meat', 'whole chicken', 'TITLE', 'BRAND', 'DESCRIPTION', 
'CONTENT, 
...
('meat', 'CATEGORY', 'TITLE GOES HERE', 'BRAND GOES HERE', 'DESCRIPTION GOES HERE', 
'CONTENT GOES HERE', 
