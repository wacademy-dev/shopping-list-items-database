...
FIELDS EXPLAINED
================
department        The department values is fixed and is set as health care
...
VALUES 
('health care', 'hydrogen peroxide', 'TITLE', 'BRAND', 'DESCRIPTION', 
'CONTENT, 
...
('health care', 'CATEGORY', 'TITLE GOES HERE', 'BRAND GOES HERE', 'DESCRIPTION GOES HERE', 
'CONTENT GOES HERE', 
