...
FIELDS EXPLAINED
================
department        The department values is fixed and is set as household supplies
...
VALUES 
('household supplies', 'detergent', 'DESCRIPTION', 
'CONTENT, 
'5000', false, nul, 'Nil', null, null, 450g, 'null', null, 1, 'Keep in a dry place', now()),
...
('household supplies', 'CATEGORY', 'TITLE GOES HERE', 'BRAND GOES HERE', 'DESCRIPTION GOES HERE', 
'CONTENT GOES HERE', 
